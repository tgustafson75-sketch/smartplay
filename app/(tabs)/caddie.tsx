...
export default function CaddieTab() {
  ...
  // 2026-07-28 (Tim) — the L4 green-chevron shortcut bar was removed (not needed anymore); its
  // expand/collapse state went with it. See the removal note in the render.
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      {/* 2026-07-28 (Tim) — the L4 green-chevron shortcut bar was REMOVED: it's not needed anymore.
          Everything it held is reachable more directly now — the mic is CaddieBottomBar's neon mic,
          SmartFinder is the floating reticle shortcut (above), SmartVision is a tap on the hole map,
          and Mark / TightLie / trust-level are available via voice + the ⋯ Tools menu. Removing it
          also declutters the map, which reads as the lead (larger) element. */}
