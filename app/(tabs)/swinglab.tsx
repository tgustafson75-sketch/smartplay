...
import { isShelved, isOwnerOnly, isBeta, SHELVED_BADGE, BETA_BADGE } from '../../services/releaseSurface';
...
const PRACTICE_SECTION: LauncherCardSpec[] = [
  ...
  },
  {
    ...
    // front door: 3:1 full / 2:1 short trainers + the Smart Tempo analysis card (which
