...
export default function SwingSimScreen() {
   ...
   *
   * Honest degradation: Spessard Holland has real per-hole coordinates and gets a true aerial; Webster
 ...
 *
 * Resolved 09-15 from the screen's own brief: SWINGSIM is a dark surface BY DESIGN — its own header calls for "broadcast presentation": cinematic flyover, TV-style tracer, lower-third banners. Broadcast furniture is dark.
 *
 ...
 */function makeStyles() {
  return StyleSheet.create({
    ...
    courseSub: { color: '#c0c9d2', fontSize: 12, marginTop: 2 },
    ...
    toggleText: { color: '#c0c9d2', fontSize: 12, fontWeight: '900', letterSpacing: 1 },
    ...
    hudLabel: { color: '#c0c9d2', fontSize: 9, fontWeight: '800', letterSpacing: 1, marginTop: 2 },
    ...
    scPar: { color: '#c0c9d2', width: 50, fontSize: 12 },
    scStrokes: { fontSize: 16, fontWeight: '900', width: 30 },
    scGhost: { color: '#c0c9d2', fontSize: 12, width: 40 },
    scName: { color: '#c0c9d2', fontSize: 12, fontWeight: '800', flex: 1, textAlign: 'right' },
    ghostHeader: { color: NEON, fontSize: 12, fontWeight: '900', letterSpacing: 1.2 },
    ghostSub: { color: '#c0c9d2', fontSize: 12, marginTop: 3 },
    ...
    ghostVerdictSub: { color: '#c0c9d2', fontSize: 12, marginTop: 4 },
    ghostBtn: { marginTop: 12, alignItems: 'center', paddingVertical: 12 },
    ghostText: { color: '#c0c9d2', fontSize: 14, fontWeight: '700' },
  });
}
