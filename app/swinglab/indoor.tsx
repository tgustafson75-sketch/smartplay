...
function makeStyles(colors: ReturnType<typeof useTheme>['colors']) {
  return StyleSheet.create({
    ...
    subtitle: { color: '#c0c9d2', fontSize: 11, marginTop: 2 },
    ...
    tempoBench: { color: '#c0c9d2', fontSize: 12, marginTop: 2 },
    ...
    repCount: { color: '#c0c9d2', fontSize: 13, marginTop: 8 },
    ...
    statLabel: { color: '#c0c9d2', fontSize: 10, fontWeight: '800', letterSpacing: 0.8, marginTop: 4, textAlign: 'center' },
    sectionLabel: { color: '#c0c9d2', fontSize: 11, fontWeight: '900', letterSpacing: 1.2, marginBottom: 8 },
