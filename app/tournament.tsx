...
const styles = StyleSheet.create({
  ...
  tabBtnText: { color: '#c2cad4', fontSize: 13, fontWeight: '600' },
  tabBtnTextActive: { color: '#00C896' },

  sectionLabel: { color: '#c2cad4', fontSize: 11, fontWeight: '700', letterSpacing: 1.2, marginTop: 18, marginBottom: 8 },
  ...
  formatHint: { color: '#c2cad4', fontSize: 11, marginTop: 2 },
  ...
  matchPlayHint: { color: '#c2cad4', fontSize: 11, marginTop: 8, fontStyle: 'italic' },
  ...
  parSmall: { color: '#c2cad4', fontSize: 11, marginTop: 2 },
  scoringFormat: { color: '#c2cad4', fontSize: 11, textAlign: 'center', paddingVertical: 8, backgroundColor: '#0d2418' },
  ...
  leaderSub: { color: '#c2cad4', fontSize: 11, marginTop: 4 },
  ...
  leaderSec: { color: '#c2cad4', fontSize: 11, marginTop: 2 },
