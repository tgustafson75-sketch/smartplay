...
export default function History() {
  ...
  return (
    <>
      ...
      {/* Tools dropdown — absolute, outside scroll */}
      {showToolsMenu && (
        <View style={{ position: 'absolute', top: 62, right: 16, zIndex: 100, backgroundColor: '#111', borderRadius: 14, borderWidth: 1, borderColor: '#2a2a2a', padding: 10, gap: 8, minWidth: 190, shadowColor: '#000', shadowOpacity: 0.5, shadowRadius: 12, elevation: 12 }}>
          <Pressable onPress={() => { setShowToolsMenu(false); router.push('/rangefinder'); }} style={{ flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8, paddingHorizontal: 10, borderRadius: 10, backgroundColor: '#332900', borderWidth: 1, borderColor: '#FFE600' }}>
          ...
          <Pressable onPress={() => setQuietMode((q) => !q)} style={{ flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8, paddingHorizontal: 10, borderRadius: 10, backgroundColor: quietMode ? '#143d22' : '#1a1a1a', borderWidth: 1, borderColor: quietMode ? '#4caf50' : '#2a2a2a' }}>
          ...
          <Pressable onPress={() => setBrightMode(!brightMode)} style={{ flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8, paddingHorizontal: 10, borderRadius: 10, backgroundColor: brightMode ? '#143d22' : '#1a1a1a', borderWidth: 1, borderColor: brightMode ? '#4caf50' : '#2a2a2a' }}>
          ...
          <Pressable onPress={() => { setShowToolsMenu(false); router.push('/analytics'); }} style={{ flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8, paddingHorizontal: 10, borderRadius: 10, backgroundColor: '#1a1535', borderWidth: 1, borderColor: '#a78bfa' }}>
            <MCIcon name="chart-bar" size={18} color="#c4b5fd" />
            <Text style={{ color: '#c4b5fd', fontSize: 14, fontWeight: '600' }}>Deep Analytics</Text>
          </Pressable>
          <Pressable onPress={handleOpenProfile} style={{ flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8, paddingHorizontal: 10, borderRadius: 10, backgroundColor: '#143d22', borderWidth: 1, borderColor: '#4caf50' }}>
            <MCIcon name="account-outline" size={18} color="#A7F3D0" />
            <Text style={{ color: '#A7F3D0', fontSize: 14, fontWeight: '600' }}>Profile</Text>
          </Pressable>
          <Pressable onPress={() => { setShowToolsMenu(false); router.push('/tutorial'); }} style={{ flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8, paddingHorizontal: 10, borderRadius: 10, backgroundColor: '#0f2a1e', borderWidth: 1, borderColor: '#34d399' }}>
            <MCIcon name="book-open-outline" size={18} color="#6ee7b7" />
            <Text style={{ color: '#6ee7b7', fontSize: 14, fontWeight: '600' }}>View Tutorial</Text>
          </Pressable>
          <Pressable onPress={() => { void handleLogout(); }} style={{ flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8, paddingHorizontal: 10, borderRadius: 10, backgroundColor: '#2a1111', borderWidth: 1, borderColor: '#ef4444' }}>
      ...
      {/* My Golf Profile link — below stats card */}
      <Pressable
        onPress={() => router.push('/profile' as any)}
        style={{ flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: 'rgba(46,204,113,0.08)', borderRadius: 14, padding: 14, borderWidth: 1, borderColor: 'rgba(46,204,113,0.22)', marginBottom: 16 }}
      >
        <View style={{ width: 36, height: 36, borderRadius: 18, backgroundColor: 'rgba(46,204,113,0.14)', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: Palette.positive }}>
          <MCIcon name="account-outline" size={18} color={Palette.positive} />
        </View>
        <View style={{ flex: 1 }}>
          <Text style={{ color: '#fff', fontSize: 14, fontWeight: '700' }}>My Golf Profile</Text>
          <Text style={{ color: 'rgba(255,255,255,0.45)', fontSize: 12, marginTop: 1 }}>Stats · Trends · Highlights</Text>
        </View>
        <MCIcon name="chevron-right" size={20} color={Palette.positive} />
      </Pressable>
