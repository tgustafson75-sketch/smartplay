...
export function capabilitiesForPrompt(): string {
  return [
    ...
    "- Strategy & mind: \"what's the play\", \"should I go for it\", a tough-love Golf-Father read (when enabled), rules questions — and mental-game coaching: I read frustration or confidence and give a reset, as much as club selection.",
