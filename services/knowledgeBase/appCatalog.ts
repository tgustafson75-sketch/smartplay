...
const ALL_APP_FEATURES: AppFeature[] = [
  ...
  // 2026-07-29 (Tim — "Caddie needs FULL awareness of ALL tools/features"). Added the remaining
  // real, user-facing screens the catalog was missing. Every route verified against the app/ tree.
  {
    id: 'swingsim',
    name: 'SwingSim',
    aliases: ['swing sim', 'swingsim', 'simulator', 'sim round', 'phone as a club', 'play a virtual round'],
    route: '/swinglab/simround',
    category: 'play',
    blurb: 'Phone-as-a-club swing simulator — play a virtual round with aerials + Ghost/Family',
    whenToUse: 'they want to swing the phone like a club and play a simulated round indoors/anywhere',
  },
  {
    id: 'hotel-mode',
    name: 'Hotel Mode',
    aliases: ['hotel mode', 'indoor mode', 'indoor practice', 'practice indoors', 'room mode'],
    route: '/swinglab/indoor',
    category: 'practice',
    blurb: 'Indoor / hotel-room practice — swing work with no ball and limited space',
    whenToUse: 'they are indoors or in a hotel room with no ball',
  },
  {
    id: 'coach-lesson',
    name: 'Coach Lesson',
    aliases: ['coach lesson', 'give me a lesson', 'coach me', 'live lesson', 'virtual lesson'],
    route: '/swinglab/coach-lesson',
    category: 'play',
    blurb: 'Live camera-first lesson loop — the caddie watches, coaches, and re-checks in real time',
    whenToUse: 'they want a real-time coached lesson on their swing',
  },
  {
    id: 'bilateral',
    name: 'Two-Angle Analysis',
    aliases: ['two angle', 'bilateral', 'second angle', 'down the line and face on', 'multi angle'],
    route: '/swinglab/bilateral',
    category: 'analyze',
    blurb: 'Combine a down-the-line and a face-on capture for a fuller swing read',
    whenToUse: 'they have (or want) two camera angles of the same swing',
  },
  {
    id: 'space-scan',
    name: 'Space Scan',
    aliases: ['space scan', 'scan my space', 'read my range', 'read the environment', 'scan the range'],
    route: '/swinglab/space-scan',
    category: 'analyze',
    blurb: 'Camera read of your practice environment so the caddie tailors the session',
  ...
  },
  {
    id: 'arccos-import',
    name: 'Arccos Import',
    aliases: ['arccos import', 'import arccos', 'import my arccos', 'smart club distances', 'import my distances'],
    route: '/arccos-import',
    category: 'prepare',
    blurb: 'Import your Arccos Smart Club Distances screenshot to seed your bag carries',
    whenToUse: 'they have Arccos club-distance numbers to bring in',
  },
  {
    id: 'lie-analysis',
    name: 'Lie Check',
    aliases: ['lie check', 'check my lie', 'analyze my lie', 'look at my lie', 'tight lie', 'read my lie'],
    route: '/lie-analysis',
    category: 'caddie',
    blurb: 'Camera read of your ball\'s lie to inform the smart play',
    whenToUse: 'they ask you to look at / check / analyze their ball lie',
  },
  {
    id: 'tournament',
  ...
  },
  {
    id: 'tee-goals',
    name: 'Tee Goals',
    aliases: ['tee goals', 'score goal', 'break ninety', 'break 90', 'break eighty', 'set a goal from the tees'],
    route: '/tee-goals',
    category: 'prepare',
    blurb: 'Set a target score from a chosen tee set (e.g. break 90 from the whites)',
    whenToUse: 'they want to set a scoring goal from specific tees',
  },
  {
    id: 'add-course',
    name: 'Add a Course',
    aliases: ['add a course', 'add my course', 'add this course', 'my course is not here', 'course not listed'],
    route: '/add-course',
    category: 'play',
    blurb: 'Add a course we don\'t have yet (search, or build it from a scorecard)',
    whenToUse: 'their course isn\'t in the list and they want to add it',
  },
  {
    id: 'jukebox',
    name: 'Music',
    aliases: ['music', 'jukebox', 'play music', 'put on some music', 'play a song'],
    route: '/jukebox',
    category: 'data',
    blurb: 'Play music (YouTube) while you practice or play',
    whenToUse: 'they want to put on music',
  },
  {
    id: 'settings',
    name: 'Settings',
    aliases: ['settings', 'open settings', 'preferences', 'options', 'change a setting'],
    route: '/settings',
    category: 'data',
    blurb: 'Voice, caddie personality, units, handedness, language, imports, and more',
    whenToUse: 'they want to change an app setting or preference',
  },
  {
    id: 'profile',
    name: 'Profile',
    aliases: ['profile', 'my profile', 'my handicap', 'my home course', 'edit my profile'],
    route: '/profile',
    category: 'data',
