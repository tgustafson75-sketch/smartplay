...
export const CHECKLIST_SECTIONS: readonly ChecklistSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'a8', label: 'Trust L1 (Quiet) silences proactive speech but allows userInitiated taps' },
      { id: 'a9', label: 'Trust L5 (Cockpit) minimal-surface inherits L1 proactive silence' },
      { id: 'a10', label: 'Slider order shows L5 adjacent to L1 (TRUST_LEVEL_SLIDER_ORDER)' },
    ],
  },
  {
    id: 'features',
    ...
    items: [
      ...
      { id: 'f15', label: 'Caddie rewards: silent at L1; fire at L2-L4; silent at L5' },
