...
const AVATARS = {
  ...
  kevin_nod:           require('../assets/avatars/kevin-idle-001.jpg'),
  kevin_idle:          require('../assets/avatars/kevin-idle-001.jpg'),
  kevin_listening:     require('../assets/avatars/kevin-listening-001.jpg'),
  kevin_explaining:    require('../assets/avatars/kevin-explaining-001.jpg'),
  kevin_focused:       require('../assets/avatars/kevin-focused-portrait-001.jpg'),
  kevin_determined:    require('../assets/avatars/kevin-determined-portrait-001.jpg'),
  kevin_pensive:       require('../assets/avatars/kevin-pensive-portrait-001.jpg'),
  kevin_inquisitive:   require('../assets/avatars/kevin-inquisitive-portrait-001.jpg'),
  kevin_mentorship:    require('../assets/avatars/kevin-mentorship-001.jpg'),
  kevin_humble:        require('../assets/avatars/kevin-humble-portrait-001.jpg'),
  kevin_supportive:    require('../assets/avatars/kevin-supportive-portrait-001.jpg'),
  kevin_happy:         require('../assets/avatars/kevin-happy-portrait-001.jpg'),
  kevin_enthusiastic:  require('../assets/avatars/kevin-enthusiastic-portrait-001.jpg'),
  kevin_surprised:     require('../assets/avatars/kevin-surprised-portrait-001.jpg'),
  kevin_celebrating:   require('../assets/avatars/kevin-celebrating-001.jpg'),
  kevin_confident:     require('../assets/avatars/kevin-confident-001.jpg'),
  kevin_gameface:      require('../assets/avatars/kevin-gameface-001.jpg'),
  kevin_curious:       require('../assets/avatars/kevin-curious-001.jpg'),
  kevin_wincing:       require('../assets/avatars/kevin-wincing-001.jpg'),
  kevin_self_critical: require('../assets/avatars/kevin-humble-portrait-001.jpg'),
} as const;
...
const SERENA_AVATARS: Record<AvatarKey, ImageSourcePropType> = {
  ...
  kevin_pensive:       require('../assets/avatars/serena-studio-portrait-001.jpg'),
  kevin_inquisitive:   require('../assets/avatars/serena-studio-portrait-001.jpg'),
  kevin_humble:        require('../assets/avatars/serena-studio-portrait-001.jpg'),
  kevin_surprised:     require('../assets/avatars/serena-studio-portrait-001.jpg'),
  kevin_confident:     require('../assets/avatars/serena-studio-portrait-001.jpg'),
};
...
const HARRY_AVATARS: Record<AvatarKey, ImageSourcePropType> = {
  kevin_course:        require('../assets/avatars/harry_portrait.jpg'),
  kevin_dark:          require('../assets/avatars/harry_moods_serious.jpg'),
  kevin_nod:           require('../assets/avatars/harry_expressive_friendly_smile.jpg'),
  kevin_idle:          require('../assets/avatars/harry_expressive_friendly_smile.jpg'),
  kevin_listening:     require('../assets/avatars/harry_expressive_attentive.jpg'),
  kevin_explaining:    require('../assets/avatars/harry_moods_pointing_at_you.jpg'),
  kevin_focused:       require('../assets/avatars/harry_moods_serious.jpg'),
  kevin_determined:    require('../assets/avatars/harry_moods_ready.jpg'),
  kevin_pensive:       require('../assets/avatars/harry_moods_thoughtful.jpg'),
  kevin_inquisitive:   require('../assets/avatars/harry_expressive_suspicious.jpg'),
  kevin_mentorship:    require('../assets/avatars/harry_moods_knowing_smile.jpg'),
  kevin_humble:        require('../assets/avatars/harry_moods_tipping_cap.jpg'),
  kevin_supportive:    require('../assets/avatars/harry_moods_approving.jpg'),
  kevin_happy:         require('../assets/avatars/harry_expressive_warm_smile_wide.jpg'),
  kevin_enthusiastic:  require('../assets/avatars/harry_expressive_laughing.jpg'),
  kevin_surprised:     require('../assets/avatars/harry_expressive_surprised.jpg'),
  kevin_celebrating:   require('../assets/avatars/harry_expressive_celebrating.jpg'),
  kevin_confident:     require('../assets/avatars/harry_moods_knowing_smile.jpg'),
  kevin_gameface:      require('../assets/avatars/harry_expressive_stern.jpg'),
  kevin_curious:       require('../assets/avatars/harry_expressive_attentive.jpg'),
