...
export const COURSE_DB: Course[] = [
  // ── 1. Menifee Lakes – Palms ────────────────────────────────────────────
  {
    ...
    holes: [
      { hole: 1,  par: 4, distance: 368, note: 'Wide landing area, open tee shot',    tee: { lat: 33.6861, lng: -117.1820 }, front: { lat: 33.6889, lng: -117.1820 }, middle: { lat: 33.6891, lng: -117.1820 }, back: { lat: 33.6892, lng: -117.1820 }, thumbnail: require('../assets/images/palms/palms-h1.jpg'),  fullImage: require('../assets/images/palms/palms-h1.jpg') },
      { hole: 2,  par: 4, distance: 353, note: 'Water short-left, aim center',         tee: { lat: 33.6866, lng: -117.1845 }, front: { lat: 33.6894, lng: -117.1832 }, middle: { lat: 33.6895, lng: -117.1832 }, back: { lat: 33.6897, lng: -117.1832 }, thumbnail: require('../assets/images/palms/palms-h2.jpg'),  fullImage: require('../assets/images/palms/palms-h2.jpg'),  hazards: [{ type: 'water',  x: 0.25, y: 0.75, r: 0.08, avoidDir: 'right' }] },
      { hole: 3,  par: 4, distance: 356, note: 'Dogleg right, trees on corner',        tee: { lat: 33.6873, lng: -117.1852 }, front: { lat: 33.6901, lng: -117.1845 }, middle: { lat: 33.6902, lng: -117.1845 }, back: { lat: 33.6904, lng: -117.1845 }, thumbnail: require('../assets/images/palms/palms-h3.jpg'),  fullImage: require('../assets/images/palms/palms-h3.jpg'),  hazards: [{ type: 'ob',     x: 0.78, y: 0.55, r: 0.07, avoidDir: 'left'  }] },
      { hole: 4,  par: 5, distance: 489, note: 'Reachable par 5, bunkers right',       tee: { lat: 33.6870, lng: -117.1858 }, front: { lat: 33.6909, lng: -117.1858 }, middle: { lat: 33.6910, lng: -117.1858 }, back: { lat: 33.6912, lng: -117.1858 }, thumbnail: require('../assets/images/palms/palms-h4.jpg'),  fullImage: require('../assets/images/palms/palms-h4.jpg'),  hazards: [{ type: 'bunker', x: 0.72, y: 0.45, r: 0.06, avoidDir: 'left'  }] },
      { hole: 5,  par: 4, distance: 367, note: 'Long par 4, slight dogleg left',       tee: { lat: 33.6888, lng: -117.1877 }, front: { lat: 33.6917, lng: -117.1870 }, middle: { lat: 33.6918, lng: -117.1870 }, back: { lat: 33.6919, lng: -117.1870 }, thumbnail: require('../assets/images/palms/palms-h5.jpg'),  fullImage: require('../assets/images/palms/palms-h5.jpg'),  hazards: [{ type: 'bunker', x: 0.22, y: 0.50, r: 0.06, avoidDir: 'right' }] },
      { hole: 6,  par: 4, distance: 379, note: 'Long straight hole, bunker guards',    tee: { lat: 33.6894, lng: -117.1883 }, front: { lat: 33.6923, lng: -117.1883 }, middle: { lat: 33.6925, lng: -117.1883 }, back: { lat: 33.6927, lng: -117.1883 }, thumbnail: require('../assets/images/palms/palms-h6.jpg'),  fullImage: require('../assets/images/palms/palms-h6.jpg') },
      { hole: 7,  par: 4, distance: 353, note: 'Water right of green, lay up left',    tee: { lat: 33.6904, lng: -117.1896 }, front: { lat: 33.6931, lng: -117.1896 }, middle: { lat: 33.6933, lng: -117.1896 }, back: { lat: 33.6935, lng: -117.1896 }, thumbnail: require('../assets/images/palms/palms-h7.jpg'),  fullImage: require('../assets/images/palms/palms-h7.jpg'),  hazards: [{ type: 'water',  x: 0.75, y: 0.20, r: 0.09, avoidDir: 'left'  }] },
      { hole: 8,  par: 4, distance: 332, note: 'Tight fairway, bunker short-left',     tee: { lat: 33.6913, lng: -117.1908 }, front: { lat: 33.6939, lng: -117.1908 }, middle: { lat: 33.6940, lng: -117.1908 }, back: { lat: 33.6942, lng: -117.1908 }, thumbnail: require('../assets/images/palms/palms-h8.jpg'),  fullImage: require('../assets/images/palms/palms-h8.jpg'),  hazards: [{ type: 'bunker', x: 0.28, y: 0.65, r: 0.06, avoidDir: 'right' }] },
      { hole: 9,  par: 5, distance: 469, note: 'Finishing front nine, birdie chance',  tee: { lat: 33.6910, lng: -117.1921 }, front: { lat: 33.6948, lng: -117.1921 }, middle: { lat: 33.6949, lng: -117.1921 }, back: { lat: 33.6951, lng: -117.1921 }, thumbnail: require('../assets/images/palms/palms-h9.jpg'),  fullImage: require('../assets/images/palms/palms-h9.jpg') },
      { hole: 10, par: 4, distance: 364, note: 'Slight dogleg right, open approach',   tee: { lat: 33.6926, lng: -117.1934 }, front: { lat: 33.6955, lng: -117.1934 }, middle: { lat: 33.6956, lng: -117.1934 }, back: { lat: 33.6957, lng: -117.1934 }, thumbnail: require('../assets/images/palms/palms-h10.jpg'), fullImage: require('../assets/images/palms/palms-h10.jpg') },
      { hole: 11, par: 5, distance: 470, note: 'Long par 5, elevated green',           tee: { lat: 33.6924, lng: -117.1947 }, front: { lat: 33.6962, lng: -117.1947 }, middle: { lat: 33.6963, lng: -117.1947 }, back: { lat: 33.6964, lng: -117.1947 }, thumbnail: require('../assets/images/palms/palms-h11.jpg'), fullImage: require('../assets/images/palms/palms-h11.jpg') },
      { hole: 12, par: 3, distance: 170, note: 'Short iron to well-guarded green',     tee: { lat: 33.6957, lng: -117.1960 }, front: { lat: 33.6971, lng: -117.1960 }, middle: { lat: 33.6972, lng: -117.1960 }, back: { lat: 33.6973, lng: -117.1960 }, thumbnail: require('../assets/images/palms/palms-h12.jpg'), fullImage: require('../assets/images/palms/palms-h12.jpg') },
      { hole: 13, par: 4, distance: 380, note: 'Tight fairway, slight dogleg',         tee: { lat: 33.6948, lng: -117.1980 }, front: { lat: 33.6979, lng: -117.1972 }, middle: { lat: 33.6980, lng: -117.1972 }, back: { lat: 33.6981, lng: -117.1972 }, thumbnail: require('../assets/images/palms/palms-h13.jpg'), fullImage: require('../assets/images/palms/palms-h13.jpg') },
      { hole: 14, par: 5, distance: 455, note: 'Reachable par 5, open landing',        tee: { lat: 33.6949, lng: -117.1985 }, front: { lat: 33.6985, lng: -117.1985 }, middle: { lat: 33.6986, lng: -117.1985 }, back: { lat: 33.6987, lng: -117.1985 }, thumbnail: require('../assets/images/palms/palms-h14.jpg'), fullImage: require('../assets/images/palms/palms-h14.jpg') },
      { hole: 15, par: 3, distance: 152, note: 'Short par 3, well-guarded green',      tee: { lat: 33.6982, lng: -117.1998 }, front: { lat: 33.6993, lng: -117.1998 }, middle: { lat: 33.6994, lng: -117.1998 }, back: { lat: 33.6995, lng: -117.1998 }, thumbnail: require('../assets/images/palms/palms-h15.jpg'), fullImage: require('../assets/images/palms/palms-h15.jpg') },
      { hole: 16, par: 4, distance: 375, note: 'Straight hole, bunker both sides',     tee: { lat: 33.6971, lng: -117.2011 }, front: { lat: 33.7000, lng: -117.2011 }, middle: { lat: 33.7002, lng: -117.2011 }, back: { lat: 33.7003, lng: -117.2011 }, thumbnail: require('../assets/images/palms/palms-h16.jpg'), fullImage: require('../assets/images/palms/palms-h16.jpg') },
      { hole: 17, par: 4, distance: 330, note: 'Water left off tee, bail right',       tee: { lat: 33.6982, lng: -117.2024 }, front: { lat: 33.7007, lng: -117.2024 }, middle: { lat: 33.7009, lng: -117.2024 }, back: { lat: 33.7010, lng: -117.2024 }, thumbnail: require('../assets/images/palms/palms-h17.jpg'), fullImage: require('../assets/images/palms/palms-h17.jpg') },
      { hole: 18, par: 4, distance: 365, note: 'Finishing hole, risk-reward approach', tee: { lat: 33.6987, lng: -117.2037 }, front: { lat: 33.7016, lng: -117.2037 }, middle: { lat: 33.7017, lng: -117.2037 }, back: { lat: 33.7018, lng: -117.2037 }, thumbnail: require('../assets/images/palms/palms-h18.jpg'), fullImage: require('../assets/images/palms/palms-h18.jpg') },
    ],
  },
