...
export const RULES_REFERENCE: RuleEntry[] = [
  // ─── FREE RELIEF ──────────────────────────────────────────────────
  {
    ...
    rule_summary: 'Measuring DISTANCE with a device is allowed when the committee permits it. Gauging SLOPE or elevation change is not, in a competition or any round you post for handicap — even on a device whose distance function is legal. In casual play there is nothing to switch off.',
