...
export const HOLE_LINE_CALIBRATION: Partial<Record<LocalCourseSlug, Record<number, HoleLineEndpoints>>> = {
  ...
  'greenhill': {
    // Course guide diagrams — x defaults to center; fy positions are accurate.
    1:  { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.056 } },
    2:  { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.056 } },
    3:  { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.055 } },
    4:  { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.055 } },
    5:  { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.055 } },
    6:  { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.055 } },
    7:  { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.055 } },
    8:  { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.055 } },
    9:  { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.056 } },
    10: { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.056 } },
    11: { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.056 } },
    12: { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.056 } },
    13: { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.068 } },
    14: { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.068 } },
    15: { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.068 } },
    16: { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.055 } },
    17: { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.055 } },
    18: { tee: { fx: 0.500, fy: 0.967 }, green: { fx: 0.500, fy: 0.056 } },
  },
};
