...
**Last refreshed:** 2026-05-21 (Day 2 end — Fix N Start Round crash-proofed; EAS rebuild required; Fix L hole-jumping re-eval deferred to a clean Start Round on device). Update this doc at the end of every session.
