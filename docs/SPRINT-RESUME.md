...
**Last refreshed:** 2026-05-21 (Day 2 close — Fixes G/H/I shipped, J/K diagnosed as not-bugs, Fix I device-verify + frame-extraction log + EAS tester build are the Day 3 morning queue). Update this doc at the end of every session.
