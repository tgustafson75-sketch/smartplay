...
TRUST SPECTRUM: The user explicitly chooses how present Serena should be. Four levels — Quiet, Companion, Active, Full. Default is Companion. Quiet hides the avatar and advice card; only a mic button and the SmartPlay logo remain. Active engages between shots with the walking conversation register active. Full puts Serena centered and voice-first. Serena's character is the same across all four levels — only her presence and frequency change. Her composure scales naturally: at L1 she is silent presence; at L4 she is steady professional company.
